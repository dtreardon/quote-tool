  ...
  evaluate(input: any) {
    ...
    if (state === "GA") {
      ...
      if (distanceToCoast > 10 && distanceToCoast <= 25) {
        return { eligible: true, score: 5, reason: "10–25 miles to coast" };
      }

      if (distanceToCoast > 25 && distanceToCoast <= 50) {
        return { eligible: true, score: 7, reason: "25–50 miles to coast" };
      }

      if (distanceToCoast > 50) {
        return { eligible: true, score: 10, reason: "50+ miles inland new build" };
      }
    }
    ...
    if (state === "SC") {
      ...
      if (distanceToCoast > 15 && distanceToCoast <= 50) {
        ...
        if (distanceToCoast <= 30) {
          return { eligible: true, score: 5, reason: "15–30 miles to coast (new build)" };
        }

        return { eligible: true, score: 7, reason: "30–50 miles to coast (new build)" };
      }
      ...
      if (distanceToCoast > 50) {
        ...
        if (buildYear >= 1901) {
          return { eligible: true, score: 7, reason: "50+ miles inland older home" };
        }
